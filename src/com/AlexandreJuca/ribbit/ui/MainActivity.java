...
import com.AlexandreJuca.ribbit.utils.RequestConstants;
...
public class MainActivity extends FragmentActivity implements ActionBar.TabListener {
	...
	private void handleCameraActions(int which){
		/*
		 *  This method handles the camera actions and starts the proper intent depending on which option was selected
		 *  @param which : An integer representing option that was selected
		 */ 
			Intent cameraIntent;
			switch(which)
			{
				...
				case 1:
					...
					cameraIntent.putExtra(MediaStore.EXTRA_DURATION_LIMIT, 2);
	...
	protected boolean isExternalMemoryAvailable(){
		/*
		 *  Checks if there is enough external storage before recording anything
	...
	protected Uri getOutPutMediaUri(int mediaType) {
		/*
		 *  This method gets the output media uri with the path and returns the uri object with the data 
		 */ 
